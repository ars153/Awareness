...
to infect-susceptibles
   ask susceptibles [
     ...
     let infected-contacts (count infecteds in-radius z-infection-init) ;; this is the number of infecteds contacted by this susceptible, and is the sum of
             ;; the number of infecteds within the radius z-infection

    let infection-chance (r / post-infection-countdown / (count turtles in-radius z-infection-init))

    let infection-prob 1 - ((1 - infection-chance) ^ infected-contacts)   ;; probability of at least one of these contacts causing infection is
...
to remove-infecteds
  ask infecteds with [time-left = 0] [ ;; Any infected whose time is up will either recover or die
    ...
    ifelse recovery <= p-recover-init * 1000 ;; If the infected recovers it is set to be removed, if not, it is set to be killed
    [set to-remove? true]
    [set to-die? true]
  ]
 end
...
to modify-contact
  ...
  if(ticks >= phase1 and ticks < phase2) [set r r-phase1]

  if(ticks >= phase2) [set r r-phase2]
...
<experiments>
  ...
  <experiment name="orkney" repetitions="10" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <metric>count the-dead</metric>
    <steppedValueSet variable="density" first="0.1" step="0.1" last="0.5"/>
    <steppedValueSet variable="initial-inf" first="1" step="2" last="9"/>
    <enumeratedValueSet variable="ii-contact-modifier">
      <value value="0.02"/>
    </enumeratedValueSet>
    ...
    <steppedValueSet variable="sd-threshold" first="0.01" step="0.1" last="0.21"/>
    <enumeratedValueSet variable="post-infection-countdown">
      <value value="18"/>
    </enumeratedValueSet>
    ...
    <steppedValueSet variable="default-contact-chance" first="0.4" step="0.2" last="1"/>
  ...
  <experiment name="orkney-1" repetitions="10" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <metric>count the-dead</metric>
    <enumeratedValueSet variable="density">
  ...
  <experiment name="orkney-1-close" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>count the-dead</metric>
    <enumeratedValueSet variable="density">
    ...
    <steppedValueSet variable="initial-inf" first="5" step="1" last="7"/>
    <enumeratedValueSet variable="ii-contact-modifier">
      <value value="0.02"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="p-recover-female">
    ...
    <steppedValueSet variable="default-contact-chance" first="0.6" step="0.1" last="0.8"/>
    <enumeratedValueSet variable="p-infect-female">
      <value value="1"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="sd-contact-modifier">
  ...
  <experiment name="borders" repetitions="1" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <metric>count the-dead</metric>
    <enumeratedValueSet variable="density">
    ...
    <steppedValueSet variable="sd-threshold" first="0.01" step="0.05" last="0.21"/>
    <enumeratedValueSet variable="post-infection-countdown">
      <value value="18"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="p-recover-male">
    ...
    <steppedValueSet variable="default-contact-chance" first="0.2" step="0.2" last="1"/>
    <enumeratedValueSet variable="p-infect-female">
      <value value="1"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="sd-contact-modifier">
  ...
  <experiment name="shetland" repetitions="10" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <metric>count the-dead</metric>
    <enumeratedValueSet variable="density">
    ...
    <steppedValueSet variable="initial-inf" first="5" step="1" last="9"/>
    <enumeratedValueSet variable="ii-contact-modifier">
      <value value="0.02"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="p-recover-female">
  ...
  <experiment name="shetland-r" repetitions="10" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <metric>count the-dead</metric>
    <metric>count removeds</metric>
    ...
    <steppedValueSet variable="initial-inf" first="8" step="2" last="20"/>
    <enumeratedValueSet variable="r-init">
      <value value="0.8"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="r-phase1">
      <value value="2.5"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="post-infection-countdown">
      <value value="14"/>
    ...
    <enumeratedValueSet variable="r-phase2">
      <value value="0.8"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="phase1">
      <value value="0"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="max-ticks">
      <value value="100"/>
